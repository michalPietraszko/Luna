...
{	
	...
	class LUNA_API LayerStack
	{
		...
		// data structures, probably some sort of list with preallocated pool would be the best since there's probably gonna be 
		// a similar num of layer + overlays throught the life of the application, however overlays/layers can be very 
